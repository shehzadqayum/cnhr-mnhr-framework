...
**Revision history (bottom of document, §11). Key v1.3 change:** ρ-sensitivity table CNHR(e) values corrected for three non-primary rows (carried-forward draft artefact). All decision metrics unchanged.
...
|------------|----------|----------|---|---------|---|-------|--------|--------|-----------|
| £200 | £29.11 | 13 | 0.619 | £12.39 | 1.35 | £7.22 | £14.36 | £2,021 | Fallback. d=12 fails NLW. |
| **£203** | **£29.55** | **12** | **0.571** | **£12.25** | **1.55** | **£6.24** | **£14.64** | **£1,844** | **Primary. 4-on-3-off viable.** |
| £215 | £31.30 | 10 | 0.476 | £12.36 | 2.05 | £4.73 | £15.73 | £1,551 | Comfortable. τ doubles. |
| £231 | £33.62 | 8 | 0.381 | £12.30 | 2.82 | £3.44 | £17.18 | £1,235 | Abundant freedom. Low income. |
...
**Real-time application note.** The target analytical capability (documented in APP-001 §10.5) is real-time CNHR/MNHR at hourly, daily, weekly, and monthly granularity — enabling mid-shift decisions such as early termination on outperformance. APP-002's metrics (τ, π, H(δ)) are currently computed at the cycle/weekly level. Extending them to real-time would require the same v_per_hour dependency identified in APP-001: without empirically determined per-hour variable cost, real-time π_average and τ cannot be decomposed below the weekly level. Marginal π (£14.64) remains valid in real-time since it is independent of cost allocation.
...
| 1.3 | Mar 2026 | **ρ-sensitivity table corrected (§7):** CNHR(e) column had carried-forward values from an earlier draft for three non-primary rows. Corrected: £200/day £12.25→£12.39, £215/day £12.71→£12.36, £231/day £12.65→£12.30. Downstream π_avg corrected accordingly (£7.20→£7.22, £4.87→£4.73, £3.54→£3.44). Now consistent with ARCH-001 Property 1 integer-discretisation table and the applied CNHR(e) formula. Primary row (£203) was already correct. No decision metrics affected. |
