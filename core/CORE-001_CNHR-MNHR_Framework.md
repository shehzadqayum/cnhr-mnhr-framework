...
3. **By ~30 shift hours, CNHR is effectively committed.** The 1/s inertia means late-week changes are mathematically negligible. This is the foundation for any monitoring system that uses a mid-week checkpoint. (See ARCH-001 §3.3 Property 2 for the formal derivation of this crossover point and its relationship to APP-001's Day-3 monitoring protocol.)
